...
This repository stores an Electron application used to edit New Horizon's database files. New Horizon's ruleset and documentation is stored in publicly available JSON files that may be downloaded, changed and redistributed for non-commercial use.
